...
class sudoku {
	...
	private:
		...
		void Add_Lista (const list<pair<pair<unsigned int, unsigned int>, celda> > &lista);
		void Add_Celda (list<pair<pair<unsigned int, unsigned int>, celda> > &lista, const int &fila, const int &col);
};
